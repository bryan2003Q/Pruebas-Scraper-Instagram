...
He extraído un 10 post de Instagram y sus respectivos comentarios.El post fue hecho por el usuario "richardcarapaz".

{texto_consolidado}

Basándote exclusivamente en el contenido proporcionado arriba:
1. Dame una conclusión general sobre la personilidad de los usuarios que hicieron los comentarios
...
3. Analizar las características de ese perfil con un modelo 
...
"""
    ...
    try:
        ...
        output_path = os.path.join(dirname, f"Análisis_Personalidad_groq_{timestamp}.txt")
        with open(output_path, 'w', encoding='utf-8') as out_f:
            out_f.write("=== ANÁLISIS DE PERSONALIDAD (GROQ) ===\n\n")
